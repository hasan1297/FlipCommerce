...
public class MyOrdersActivity extends AppCompatActivity
{
    ...
    private void getProductsInCart()
    {
        ...
        myOrdersAdapter.update(R.drawable.shoes1,"Refund Accepted","Fahim WNDR-13 Running Shoes for Men(Green, Grey)");
        myOrdersAdapter.update(R.drawable.shoes2,"Delivered on Oct 30,2019","Fahim WNDR-13 Running Shoes for Men(Green, Grey)");
